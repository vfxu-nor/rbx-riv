-- ESP + Hard Aimbot + Rage Teleport LocalScript (With 'P' Master Toggle & Local Godmode)
...
-- ============================================================
local Config = {
    Master_Enabled = true, -- Press 'P' to toggle this on/off
...
local function applyESP(player, char)
    ...
    local renderConn = RunService.RenderStepped:Connect(function()
        ...
        -- Factor in the Master P toggle here
...
RunService.RenderStepped:Connect(function()
    ...
    -- Check master switch for FOV Circle visibility
    ...
    -- If Master switch is OFF, turn off functions below
...
task.spawn(function()
    while true do
        task.wait(0.1) 
        -- Must pass both master toggle and mode toggle check
